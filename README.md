...
The first public release was `0.1.0`. The current development version is `0.2.0` and adds local custom scenario CRUD, per-request application limits, and broad-matcher confirmation on top of the release capabilities. Non-JSON or unreadable responses pass through unchanged.
